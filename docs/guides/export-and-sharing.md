...
The IFC contains the modeled geometry, materials and supported building
relationships. Its bodies retain the final cuts and material partitions. Importing
it does not recreate the engine's editable construction history.

Check the imported dimensions, openings and assembly organization before downstream
work. See the [IFC representation contract](../reference/ifc-contract.md) for native
classes, properties, units and identity details.
...
[Drawing views and dimensions](../../skills/home-design/references/delivery.md#drawing-views-and-dimensions)
...
`schedules.json` includes all components and subsets for openings, penetrations,
framing, foundations, hardware, fasteners, reinforcement, masonry, accessories,
envelope parts, service devices/routes/fittings/insulation, systems/circuits,
stairs/guards, drainage, loads and interface details. Cavity balances, generated
members, circuit schedules, material volumes and requirements retain their
associated component identities. Stable IDs connect rows to IFC and the viewer. Quantities
...
[Terrain and sun studies](ai-design-workflow.md#terrain-and-sun-studies) for study setup, sampling and
